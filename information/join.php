...
<body>
      ...
      <ul class="clearfix">
		...
		<li class="current-item"><a href="#">Information<span class="arrow">&#9660;</span></a>
			<ul class="sub-menu">
              ...
              <li><a href="services.php">Break The Circle</a></li>
	...
	<div id="content">
        <div class="content_item">
			...
			<h2 text-align="center" style = "border-left: 6px solid red; color:#696969; background-color: lightgrey; font-weight:Bold;">Join Us</h2>
			</br>
			<h4>To join us you need to E-mail our <a href="#">Secretary</a> at iutps.org@gmail.com , or come along to one of our meetings and speak with us in person. We meet every Wednesday evening starting at 8:00 am at the 
				 <a href="https://www.facebook.com/IUTPS/">IUT</a> in Board Bazar, Gazipur.
				 Look at the events list at the left hand side of
				 this page to see when the next one is due. For
				 help with finding us <a href="../contact.php">Click Here</a>.
				 To allow you to get a feel for HHPS and whether
				 or not it's right for you, why not come along to a
				 few Wednesday meetings and see for yourself? All
