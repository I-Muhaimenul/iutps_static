...
<body>
	...
	<nav class="menu">
      <ul class="clearfix">
        ...
        <li><a href="../submit.php">Break The Circle</a></li>
	...
	<div id="content">
		...
		<h2 text-align="center" style = "border-left: 6px solid red; color:#696969; background-color: lightgrey; font-weight:Bold;">Our Members</h2>
